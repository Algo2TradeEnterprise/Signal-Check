Namespace Indicator
    Public Module SwingHighLow
        Public Sub CalculateSwingHighLow(ByVal inputPayload As Dictionary(Of Date, Payload), ByRef outputHighPayload As Dictionary(Of Date, Decimal), ByRef outputLowPayload As Dictionary(Of Date, Decimal))
