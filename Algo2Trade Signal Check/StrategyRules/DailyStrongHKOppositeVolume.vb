...
Public Class DailyStrongHKOppositeVolume
    Inherits Rule
            ...
            If stockList IsNot Nothing AndAlso stockList.Count > 0 Then
                For Each stock In stockList
                    ...
                    Select Case _category
                        Case "Cash"
                            stockPayload = _common.GetRawPayload(Common.DataBaseTable.EOD_Cash, stock, chkDate.AddDays(-50), chkDate)
                        Case "Currency"
                            stockPayload = _common.GetRawPayload(Common.DataBaseTable.EOD_Currency, stock, chkDate.AddDays(-50), chkDate)
                        Case "Commodity"
                            stockPayload = _common.GetRawPayload(Common.DataBaseTable.EOD_Commodity, stock, chkDate.AddDays(-50), chkDate)
                        Case "Future"
                            stockPayload = _common.GetRawPayload(Common.DataBaseTable.EOD_Futures, stock, chkDate.AddDays(-50), chkDate)
                        Case Else
